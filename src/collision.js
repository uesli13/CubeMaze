...
// cameraRadius: 0.1* MAZE_SCALE;      // Reduced radius for narrower corridors
// cameraHeight: 1.6* MAZE_SCALE;  // Eye level height
// cameraHalfHeight: 0.8* MAZE_SCALE;  // For vertical collision checks
